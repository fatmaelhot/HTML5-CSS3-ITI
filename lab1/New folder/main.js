...
audioPlayer.addEventListener('timeupdate', function () {
    durationRange.max = audioPlayer.duration;
    durationRange.value = audioPlayer.currentTime;
});

durationRange.addEventListener('input', function () {
    audioPlayer.currentTime = durationRange.value;
});
